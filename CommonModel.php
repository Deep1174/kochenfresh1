    ...
    **/
    ...
    function record_count($where,$table,$order_by)
    {
       ...
       $where='';
		   ...
		   $sql = "SELECT COUNT($order_by) AS TotalrecordCount FROM  $table  WHERE 1   and status=1  $where";
    ...
    */
    public function all_data_list($limit,$start,$where,$table,$order_by)
    {
       ...
       $comp_id = $this->session->userdata('ep_company_id');
		   ...
		   $sql="SELECT * FROM $table  WHERE 1 and status=1  $where ORDER BY  $order_by DESC  LIMIT ".$start.",".$limit ;  
